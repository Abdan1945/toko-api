                        ...
                        <tr v-for="(produk, index) in produks" :key="produk.id">
                            ...
                            <td style="text-align: right;">
                                <div class="d-flex gap-2" style="justify-content: flex-end;">
                                    <button @click="openEditForm(produk)" class="btn btn-secondary"
                                        style="padding: 0.25rem 0.75rem; font-size: 0.875rem;">Edit</button>
                                    <button @click="hapusProduk(produk.id)" class="btn btn-danger"
                                        style="padding: 0.25rem 0.75rem; font-size: 0.875rem;">Hapus</button>
                                </div>
                            </td>
                        </tr>
                        <tr v-if="produks.length === 0">
                            <td colspan="6" class="text-center text-muted" style="padding: 2rem;">Belum ada data produk.
                            </td>
                        </tr>
                    </tbody>
                </table>
